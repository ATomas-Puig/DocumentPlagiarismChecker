...
namespace DocumentPlagiarismChecker.Outputs
{
    ...
    /// </summary>
    internal class TerminalEjercicio: Core.BaseOutput{
        public TerminalEjercicio(): base(){
        }

        public TerminalEjercicio(string settingsFilePath): base(new Settings(settingsFilePath)){
        }

        public TerminalEjercicio(Settings settings): base(settings){
        }
